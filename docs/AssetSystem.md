...
the block registration emitted from source fields. Entity movement sweeps
against the physical collision boxes, while edit raycasts continue to hit
occupied cells rather than model faces. Neither path derives bounds from visual
geometry.
