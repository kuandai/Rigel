...
// Reports only the finite set of obsolete generation-configuration paths that
// Rigel previously loaded from the launch directory. This deliberately does
// not enumerate directories or parse legacy configuration documents.
